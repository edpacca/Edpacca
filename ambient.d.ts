...
declare module '$env/static/private' {
	export const GH_URL: string;
	export const GH_REPO_TOKEN: string;
...
declare module '$env/static/public' {
	export const PUBLIC_STRAVA_CURRENT: string;
	export const PUBLIC_STRAVA_LAST_UPDATED: string;
	export const PUBLIC_STRAVA_TARGET: string;
	export const PUBLIC_STRAVA_GOAL_YEAR: string;
	export const PUBLIC_STRAVA_GOAL: string;
}
...
declare module '$env/dynamic/public' {
	export const env: {
		PUBLIC_STRAVA_CURRENT: string;
		PUBLIC_STRAVA_LAST_UPDATED: string;
		PUBLIC_STRAVA_TARGET: string;
		PUBLIC_STRAVA_GOAL_YEAR: string;
		PUBLIC_STRAVA_GOAL: string;
