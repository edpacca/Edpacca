...
function getLangShortName(fullName) {
  switch (fullName) {
    case "Shell":
      return "Bash";
    case "TypeScript":
...
export {
  EXTERNAL_CODE_LANGS as E,
  LANG_LOGO_COLORS as L,
  STATIC_LANG_DATA as S,
  getLangShortName as g
};
