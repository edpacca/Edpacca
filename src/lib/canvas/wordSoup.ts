import { LANG_LOGO_COLORS } from '$lib/data/codeLangData';
import { resolveCollisions, type Rect, resolveCollision } from '$lib/mechanics/rect';
import { Vector2D, randomVector } from '$lib/mechanics/vector';
