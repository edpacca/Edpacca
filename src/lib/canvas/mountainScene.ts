...
export function mountainScene(
	...
	const cloudGradient = ctx.createLinearGradient(width * 0.5, height, width * 0.5, height * 0.6);
	...
	const glowGradient = ctx.createLinearGradient(width, height, width * 0.95, height * 0.35);
	...
	function animate() {
		...
		if (counter % 2 === 0) {
			...
			anCtx.clearRect(indicatorX - indicatorRadius, indicatorY - indicatorRadius, indicatorX, indicatorY);
