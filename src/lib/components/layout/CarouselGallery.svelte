<script lang="ts">
	...
	const previous = () => {
		currentIndex = currentIndex - 1 < 0 ? max - 1 : currentIndex - 1;
	};
...
<div class="gallery__container">
	...
	>
		{#key currentImage}
			<img class="gallery-img" bind:this={img} src={currentImage} alt={title} transition:fade />
			{#if showIndex}
				<div class="index" class:light-font={darkBackground} style="--img-width: {imageWidth}px;">
					#{currentIndex + 1}
				</div>
			{/if}
		{/key}
