...
I masked off different areas of a black and white photo then digitally coloured in the different areas. My other army Dark Angels are painted with warm tones, dark green, parchment bone colour and red accents - so I opted to try a cooler scheme.

To me the Warriors are the quintiscential Choas unit; I picture them as near souless husks bound to the will of their God's and Masters. I imagined a cold dark forest in winter would make a fitting setting.

After much deliberation I settled for turquoise armour and pale gold trim, with a magenta accent... wait a second. Damn. Those are basically just cold analogs of the Dark Angels scheme. I'm nothing if not predictable. I do really like green. I did think about going for something completely different but I think it really fits the theme I was conjuring in my mind, and I figured I must be drawn to these colours for a reason - so I went with it.

<ImgGrid
    imgs={[
        { path: "images/miniatures/spearhead/colourschemes/s2d_scheme1.webp" },
        { path: "images/miniatures/spearhead/colourschemes/s2d_scheme2.webp" }
    ]}
